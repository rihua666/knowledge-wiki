...
在多主题研究任务中，上下文窗口瓶颈导致幻觉。这与 [[有效上下文工程]] 中描述的 Context Rot 问题本质一致，也与 [[Manus-经验]] 中关于文件系统作为外部记忆的思路互补。
...
**Wide Research** — 部署 n 个并行子代理处理 n 个项目。类似的子代理架构也见于 [[Harness-Design]]（Planner-Generator-Evaluator）和 [[AI-Agent-Systems]]（Agent Transformer 编排模式）。
...
- [[有效上下文工程]] — Anthropic 的子代理方案解决类似问题
- [[Harness-Design]] — 子代理协调模式
- [[动态上下文发现]] — Cursor 的动态加载是另一种上下文优化方案
- [[AI-Agent-Systems]] — 单 Agent vs 多 Agent 编排模式
